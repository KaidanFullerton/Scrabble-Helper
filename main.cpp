/**
*This program is an assistant for the popular word game Scrabble. By using a hash table,
* it can determine what words you can make based on your given letters. 
*
